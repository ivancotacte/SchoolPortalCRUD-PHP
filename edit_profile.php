...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password != $confirm_password) {
        ...
        $update_query = "UPDATE tb_account SET first_name='$first_name', middle_name='$middle_name', last_name='$last_name', suffix_name='$suffix_name', campus='$campus', password='$new_password' WHERE email_address='{$_SESSION['SESSION_EMAIL']}'";

        ...
        <div class="row border rounded-4 p-3 bg-white shadow box-area">
            <div class="right-box">
                ...
                <form id="myForm" action="" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="input-group mb-2">
                            <button type="button" onclick="window.location.href = 'admin-dashboard.php';" class="btn btn-lg w-100 fs-6" style="background-color: #030067; color: #ececec;">Back</button>
                        </div>
                </div>
            </div>
        </div>

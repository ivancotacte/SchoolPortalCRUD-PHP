...
$sql = "SELECT * FROM TBL_ACCOUNT WHERE USER_ROLE = 'student'";
            ...
            <tbody>
                <?php foreach ($result as $row) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="admin-edit-profile.php?StudentNum=<?php echo $row['STUDENT_NUMBER'] ?>" class='btn btn-primary me-2'> Edit </a>
